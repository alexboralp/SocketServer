 ...
 * @author alexander
 */
public class ActionBtnFollowFamous implements ActionListener {
    ...
    public ActionBtnFollowFamous(VIPClientAdmin admin, ClientGUI clientGUI, Controller controller, VIPIPrintable printer) {
        this.admin = admin;
