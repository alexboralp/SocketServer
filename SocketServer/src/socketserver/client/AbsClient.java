 ...
 * @param <T>
 */
public abstract class AbsClient<T extends Serializable> implements IClient<T>{
     ...
     */
    public AbsClient(Socket socket) throws IOException {
        this.socket = socket;
    ...
    public void terminate() {
        try {
            ...
            Logger.getLogger(AbsClient.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
