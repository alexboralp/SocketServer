 ...
 * @author alexander
 */
public class VIPObservableObj extends OOObservableObj{
    
    public VIPObservableObj(String ownerId, OOISerializableIdable object) {
        super(ownerId, object);
    }
    
    public VIPObservableObj(OOIObservableObj obj) {
