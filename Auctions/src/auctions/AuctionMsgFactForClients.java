 ...
 * @author aborbon
 */
public class AuctionMsgFactForClients extends OOClientMsgFact {
    ...
    public static AuctionMsgMessageToBidder createMessageToBidder(String idAuction, String idBidder, String message) {
        return new AuctionMsgMessageToBidder(idAuction, idBidder, message);
    }
    
    public static AuctionMsgAuctionFinished createAuctionFinished(String idAuction, String idBidder, String messageToWinner) {
        return new AuctionMsgAuctionFinished(idAuction, idBidder, messageToWinner);
    }
    
    public static AuctionMsgNewOffer createNewOffer(String idAuction, double newOffer) {
        return new AuctionMsgNewOffer(idAuction, newOffer);
    }
    
    public static AuctionMsgAcceptOffer createAcceptOffer(String idAuction, String idBidder, double newPrice) {
        return new AuctionMsgAcceptOffer(idAuction,idBidder, newPrice);
    }
}
